...
from core.models import Item, DailyExpense, PaymentMode, TypeOfPaymentModes, PaymentTransaction
...
class DailyExpenseAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'item', 'expense', 'transaction', 'payment_through', 'comment', 'date')
    ...
    fieldsets = [
        (
            'Daily Expense', {'fields': ('item', 'transaction', 'is_loan')},
        ),
        (
            'Transaction', {
